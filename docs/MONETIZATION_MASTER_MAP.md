...
| Schedule Rail events    | **Studio Core:** manual Create Event + one-off extension reminders. **Autopost:** Coach/Goal Cycle sequences, AI posting assistant, future recurrence/smart timing/bulk. Gate automation, not event vocabulary. See [studio/PLAN_MANUAL_SOCIAL_EVENTS.md](studio/PLAN_MANUAL_SOCIAL_EVENTS.md). |
