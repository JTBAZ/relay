# Run 06 — Identity DB stores (M2 · Phase 2.2)
...
- **This run (GitHub):** [https://github.com/JTBAZ/relay/blob/main/docs/database/runs/run-06.md](https://github.com/JTBAZ/relay/blob/main/docs/database/runs/run-06.md)
- **Next run (GitHub):** [https://github.com/JTBAZ/relay/blob/main/docs/database/runs/run-07.md](https://github.com/JTBAZ/relay/blob/main/docs/database/runs/run-07.md)

---

## Handoff (queue the next agent)

When this run’s steps are verified and **Pipeline status** is **Complete** for the relevant Step IDs, start the next agent with the **full** prompt from **[Run 07](run-07.md)** (folder: `docs/database/runs/`).

**Carry forward:** DB identity stores exist; wire RELAY_DB_STORE_IDENTITY and backfill next.
