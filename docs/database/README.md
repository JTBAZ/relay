...
| [`BATTING_ORDER_AIRTABLE.md`](BATTING_ORDER_AIRTABLE.md) | **Patron Experience batting order** — Airtable workspace **Batting Order**, table **PE Batting Order** (runs P1–P4 + dual-path checklist); mirrors [`Patron_Experience_Batting_Order.md`](../Patron_Experience_Batting_Order.md) |
| [`RELAY_PRESENTATION_BACKEND_AIRTABLE.md`](RELAY_PRESENTATION_BACKEND_AIRTABLE.md) | Same **Batting Order** base (`apprid6UGT9E1KlkN`), table **relay presentation backend** — phased backend work for presentation merge + media-scoped comments (`BO-RPB-01`…`BO-RPB-06`, **RP1**–**RP6** runs); field model matches **PE Batting Order** |
