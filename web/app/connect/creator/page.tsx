...
const PATREON_OAUTH_HREF = "/connect/patreon/connect";
const SUBSCRIBESTAR_OAUTH_HREF = "/connect/subscribestar/connect/creator";
...
function SessionKeyForm() {
  ...
  async function handleSave() {
    ...
    setErrorMsg(null);
    try {
      await relayFetch<unknown>("/api/v1/connect/patreon/cookie", {
        method: "POST",
