...
/**
 * Dev helper: builds Patreon’s authorize URL. Redirect uses NEXT_PUBLIC_PATREON_REDIRECT_URI
 * or the current browser origin (must match your Patreon app + portal exactly).
 */
