...
/**
 * PE-E (BO-P2-04) — `/feed?state=...` dev preview.
 *
 ...
 * state.
 *
 * Gated by middleware: `/feed?state=...` only bypasses the auth redirect when
        ...
        <div className="mx-auto flex max-w-5xl items-start gap-2 rounded-md border border-[#2A2A2A] bg-[#141414] p-3 text-xs text-[#bbb]">
          ...
          <div>
            ...
            <div className="mt-1 text-[10px] text-[#666]">
              ...
              {" · "}
              <a className="underline-offset-2 hover:underline" href="/feed">
                exit preview
              </a>
            </div>
          </div>
