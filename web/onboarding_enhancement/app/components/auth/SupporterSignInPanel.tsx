...
export function SupporterSignInPanel({ onSuccess }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        <label htmlFor="supporter-email" className="text-xs font-medium uppercase tracking-wider text-[var(--relay-fg-muted)]">
          Email
        </label>
        <input
          id="supporter-email"
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="supporter-password" className="text-xs font-medium uppercase tracking-wider text-[var(--relay-fg-muted)]">
          Password
        </label>
        <input
