...
Open [http://127.0.0.1:3000](http://127.0.0.1:3000) with your browser (same host family as `NEXT_PUBLIC_RELAY_API_URL` in `.env.example`; do not mix with `localhost` — see `docs/qa/DEV_LOCAL_ORIGIN.md`).
