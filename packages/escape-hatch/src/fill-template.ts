...
export function fillTemplate(opts: FillOptions): FillResult {
  ...
  writeFileSync(
    ...
    [
      ...
      "`productionSafe: false` — through EH-064: CMS ops, optional Patreon sync, optional Relay Crosspost scoped ingest. Milestone 3 security/browser gate, EH-070+, and verified deploy remain open.",
      "",
