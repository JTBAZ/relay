...
export function fillTemplate(opts: FillOptions): FillResult {
  ...
  writeFileSync(
    ...
    [
      ...
      "`productionSafe: false` — through EH-070: CMS ops, optional Patreon/Crosspost, fixture Vercel golden-path rehearsal. Milestone 3 security/browser gate, EH-071+, and live provider deploys remain open.",
      "",
