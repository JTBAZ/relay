...
export function fillTemplate(opts: FillOptions): FillResult {
  ...
  writeFileSync(
    ...
    [
      ...
      "`productionSafe: false` — through EH-072: CMS ops, fixture deploy paths, transactional email recipe. Milestone 3 security/browser gate, EH-073+, and live provider proofs remain open.",
      "",
