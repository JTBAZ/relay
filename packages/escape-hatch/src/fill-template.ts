...
export function fillTemplate(opts: FillOptions): FillResult {
  ...
  writeFileSync(
    ...
    [
      ...
      "`productionSafe: false` — through EH-071: CMS ops, optional Patreon/Crosspost, fixture Vercel + Docker Path B rehearsals. Milestone 3 security/browser gate, EH-072+, and live provider deploys remain open.",
      "",
