...
- This kit is **`productionSafe: false`**: Milestone 3 security review + browser personas gate and live independence proof (**EH-082**) remain open. Do not enable `public_legacy` media mode in production.
