# Escape Hatch fixture provenance (EH-010 / EH-011 / EH-012 / EH-013 / EH-020 / EH-021 / EH-022 / EH-030 / EH-031)
...
| **EH-031** | Portable identity/data path (Postgres without `auth.users`, scrypt + opaque sessions, `eh.user_id` RLS); Path A and Path B coexist; no live DB required for package tests. |
